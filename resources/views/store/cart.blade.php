                                ...
                                <div class="p-3 border rounded-lg bg-gray-50">
                                    <div class="flex justify-between items-center flex-wrap gap-4">
                                        <div class="flex items-center gap-4">
                                            ...
                                            <img src="{{ $item->variant->media?->file_path ? cloudinary_url($item->variant->media->file_path, 'image', 'w_80,h_80,c_fill,q_auto,f_auto') : cloudinary_url('productDefault_nawcx4', 'image', 'w_80,h_80,c_fill,q_auto,f_auto')  }}"
