    ...
    <div class="card bg-white shadow-md rounded-xl border border-soft">
        <div class="card-body">
            <div class="flex justify-between items-center mb-4">
                <h2 class="text-2xl font-bold text-primary mb-4"> <i class="fas fa-bell"></i> Notifikasi</h2>

                <form action="{{ route('notifications.readAll') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-gradient-primary mb-4">
           ...
           ">
                                    ...
                                    @else
                                        <a href="{{ $notif->data['link'] }}" class="btn btn-xs btn-gradient-primary">Lihat
                                        </a>
                                    @endif
                                @endif
            ...
            ">
                ...
                <div class="flex justify-center mt-6 space-x-2">
                    ...
                    @else
                        <a href="{{ $notifications->previousPageUrl() }}" class="btn btn-gradient-primary">
                            Prev
                        </a>
                    @endif
                    ...
                    @if ($notifications->hasMorePages())
                        <a href="{{ $notifications->nextPageUrl() }}" class="btn-gradient-primary">
                            Next
                        </a>
                    @else
